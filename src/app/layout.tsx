  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content={`Hello, my name is Snowi or Sky for short. ${birthday()} and I've been coding for ${calcAge(
            new Date("2019-07-03")
          )} years. I enjoy creating open source projects on my free time or whenever I'm not lazy.`}
        />
        <meta
          property="og:description"
          content={`Hello, my name is Snowi or Sky for short. I'm currently ${calcAge(
            new Date("2004-06-29")
